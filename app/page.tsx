...
import { gallery, industries, partnerLogos, process, stats, trustStats, whyChooseUs } from "@/lib/siteData";
    ...
    <>
      <section className="relative flex min-h-[88vh] items-end overflow-hidden bg-[#071427] text-white">
        <div className="absolute inset-0">
          <img src="/assets/pal-banner.jpg" alt="Premium brass bath fittings showcase" className="hero-bg-drift h-full w-full scale-105 object-cover opacity-46" />
          ...
          <Reveal delay={0.16}>
            <div className="hero-product-panel group relative rounded-[1.45rem] border border-white/12 bg-white/[0.055] p-3 shadow-luxury backdrop-blur-2xl">
              ...
              <div className="relative overflow-hidden rounded-[1.1rem] bg-gradient-to-br from-white/[0.13] to-white/[0.035]">
                ...
                <div className="hero-progress absolute bottom-0 left-0 h-px bg-gold/80" />
              </div>
            </div>
          </Reveal>
      ...
      <section className="section-shell section-padding grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        <Reveal>
        ...
        <Reveal delay={0.12}>
          ...
          <h2 className="heading-lg mt-4 text-primary">Manufacturing excellence for elevated bathroom experiences.</h2>
          <p className="mt-5 text-base leading-8 text-black/62">
            Petrel by Pal Enterprise manufactures premium brass bath fittings, accessories, internal fittings, faucet components, and OEM-ready assemblies. Built for professional buyers, our products combine engineering accuracy, material confidence, and refined market presentation.
          </p>
